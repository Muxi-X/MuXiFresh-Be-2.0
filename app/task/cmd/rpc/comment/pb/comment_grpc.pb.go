...
const (
	...
	CommentClient_ReplySubmissionComment_FullMethodName = "/comment.commentClient/ReplySubmissionComment"
)
...
func (c *commentClientClient) GetSubmissionComment(ctx context.Context, in *GetSubmissionCommentReq, opts ...grpc.CallOption) (*GetSubmissionCommentResp, error) {
	...
	err := c.cc.Invoke(ctx, CommentClient_GetSubmissionComment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentClientClient) SetSubmissionComment(ctx context.Context, in *SetSubmissionCommentReq, opts ...grpc.CallOption) (*SetSubmissionCommentResp, error) {
	...
	err := c.cc.Invoke(ctx, CommentClient_SetSubmissionComment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentClientClient) DelSubmissionComment(ctx context.Context, in *DelSubmissionCommentReq, opts ...grpc.CallOption) (*DelSubmissionCommentResp, error) {
	...
	err := c.cc.Invoke(ctx, CommentClient_DelSubmissionComment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentClientClient) IsMyComment(ctx context.Context, in *IsMyCommentReq, opts ...grpc.CallOption) (*IsMyCommentResp, error) {
	...
	err := c.cc.Invoke(ctx, CommentClient_IsMyComment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentClientClient) ReplySubmissionComment(ctx context.Context, in *ReplySubmissionCommentReq, opts ...grpc.CallOption) (*ReplySubmissionCommentResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReplySubmissionCommentResp)
	err := c.cc.Invoke(ctx, CommentClient_ReplySubmissionComment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommentClientServer interface {
	...
	ReplySubmissionComment(context.Context, *ReplySubmissionCommentReq) (*ReplySubmissionCommentResp, error)
	mustEmbedUnimplementedCommentClientServer()
}

// UnimplementedCommentClientServer must be embedded to have
...
func (UnimplementedCommentClientServer) ReplySubmissionComment(context.Context, *ReplySubmissionCommentReq) (*ReplySubmissionCommentResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReplySubmissionComment not implemented")
}
func (UnimplementedCommentClientServer) mustEmbedUnimplementedCommentClientServer() {}
func (UnimplementedCommentClientServer) testEmbeddedByValue()                       {}
...
func RegisterCommentClientServer(s grpc.ServiceRegistrar, srv CommentClientServer) {
	// If the following call pancis, it indicates UnimplementedCommentClientServer was
...
func _CommentClient_ReplySubmissionComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReplySubmissionCommentReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommentClientServer).ReplySubmissionComment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentClient_ReplySubmissionComment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentClientServer).ReplySubmissionComment(ctx, req.(*ReplySubmissionCommentReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentClient_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReplySubmissionComment",
			Handler:    _CommentClient_ReplySubmissionComment_Handler,
		},
	},
