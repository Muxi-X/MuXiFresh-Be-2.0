...
func (s *CommentClientServer) ReplySubmissionComment(ctx context.Context, in *pb.ReplySubmissionCommentReq) (*pb.ReplySubmissionCommentResp, error) {
	l := logic.NewReplySubmissionCommentLogic(ctx, s.svcCtx)
	return l.ReplySubmissionComment(in)
}
